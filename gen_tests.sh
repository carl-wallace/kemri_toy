./kemri_toy -o output
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-384
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-512
...
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-384
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-512
...
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-384
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-512
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-384
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-512
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-384
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-512
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-384
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-512
...
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
...
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
...
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.1_ML-KEM-512_ee.der --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.2_ML-KEM-768_ee.der --kem ml-kem768 --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
...
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-384 --aead aes256-gcm --auth-env-data
./kemri_toy -o output -u "This is some User Keying Material" -c ./output/2.16.840.1.101.3.4.4.3_ML-KEM-1024_ee.der --kem ml-kem1024 --kdf hkdf-sha2-512 --aead aes256-gcm --auth-env-data
