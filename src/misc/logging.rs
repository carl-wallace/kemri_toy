//! Utility functions used by the kemri_toy utility
...
use crate::args::KemriToyArgs;

/// Configures logging per logging-related elements of the provided [KemriToyArgs] instance.
///
/// There are two logging-related options: [logging_config](KemriToyArgs::logging_config) and
/// [log_to_console](KemriToyArgs::log_to_console). Though these options are mutually exclusive, the
...
pub(crate) fn configure_logging(args: &KemriToyArgs) {
